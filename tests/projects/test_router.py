...
class TestCreateProjectEndpoint:
    ...
    def test_create_project_with_rate(self, client_with_auth):
        """Test creating project with explicit rate."""
        response = client_with_auth.post(
            "/project/",
            json={"name": "Expensive Project", "rate": 200.0},
            cookies={"access_token": client_with_auth.test_token},
        )
...
class TestUpdateProjectEndpoint:
    ...
    def test_update_project_rate(self, client_with_auth):
        """Test updating project rate."""
        # Create a project
        create_response = client_with_auth.post(
            "/project/",
            json={"name": "Test Project"},
